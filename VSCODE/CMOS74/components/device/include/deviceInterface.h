...
/** Unsigned float with hex length = 2. */
#define DEVICE_ARG_UNSIGNED_FLOAT_HEX_2   25 

/** Unsigned float with hex length = 4. */
#define DEVICE_ARG_UNSIGNED_FLOAT_HEX_4   26  

/** Unsigned float with hex length = 4. */
#define DEVICE_ARG_UNSIGNED_FLOAT_HEX_6   27  
